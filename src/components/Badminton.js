...
const Badminton = () => {
  ...
  const handleSlotSelection = (slot) => {
    ...
    alert(`You have booked the ${slot} slot for badminton.`);
  };

  return (
    <div className="flex items-center justify-center h-screen bg-cover bg-center badminton-background">
      <div className="absolute inset-0 bg-black opacity-50"></div>
      <div className="relative z-10 text-center p-5">
        <h1 className="text-white text-4xl font-bold mb-4">Badminton - Rules & Slot Booking</h1>
        <h2 className="text-white text-2xl mb-2">Rules & Regulations</h2>
        <ul className="text-white mb-4">
          <li>Non-marking shoes are required.</li>
